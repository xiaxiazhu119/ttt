...
import { SharedResultViewComponent } from './shared-result-view.component';

@NgModule({
  declarations: [SharedResultViewComponent],
  imports: [
    CommonModule,
    FormsModule, ReactiveFormsModule,
    MatInputModule, MatSelectModule, MatButtonModule, MatSnackBarModule, MatCheckboxModule,
  ],
  exports: [SharedResultViewComponent]
})
export class SharedResultViewModule { }
